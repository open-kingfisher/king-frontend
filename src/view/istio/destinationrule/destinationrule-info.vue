...
import { Get, Chart } from '@/api/istio/destinationrules.js'
...
export default {
  ...
  mounted () {
    ...
    if (this.$route.params.resourceName) {
      ...
      localStorage.setItem('destinationRulesName', this.resourceName)
    } else {
      this.resourceName = localStorage.getItem('destinationRulesName')
    }
