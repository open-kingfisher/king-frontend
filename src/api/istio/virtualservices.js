...
export const List = params => {
  return axios.request({
    url: ISTIO_URL_PREFIX + 'virtualServices',
    method: 'get'
  })
}
...
export const Get = params => {
  return axios.request({
    url: ISTIO_URL_PREFIX + 'virtualServices/' + params.resourceName,
    method: 'get',
    params: {
...
export const Chart = params => {
  return axios.request({
    url: ISTIO_URL_PREFIX + 'virtualServicesChart/' + params.resourceName,
    method: 'get',
    params: {
      productId: params.productId
    }
