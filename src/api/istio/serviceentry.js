...
export const List = params => {
  return axios.request({
    url: ISTIO_URL_PREFIX + 'serviceEntries',
    method: 'get'
  })
}
...
export const Get = params => {
  return axios.request({
    url: ISTIO_URL_PREFIX + 'serviceEntries/' + params.resourceName,
    method: 'get',
    params: {
...
export const Chart = params => {
  return axios.request({
    url: ISTIO_URL_PREFIX + 'serviceEntriesChart/' + params.resourceName,
    method: 'get',
    params: {
      productId: params.productId
    }
